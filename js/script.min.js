...
// 	var idleWait = 10000; // время ожидания в мс. (1/1000 секунды)
...
// 			$('.slider-container').addClass('active-slider')

// 		} else {

// 			$('.slider-container').removeClass('active-slider')
...
// 	};
	...
	function next_slide() {
		...
		$('.slider-newspaper').slick('slickNext');
	...
	function prev_slide() {
		...
		$('.slider-newspaper').slick('slickPrev');
